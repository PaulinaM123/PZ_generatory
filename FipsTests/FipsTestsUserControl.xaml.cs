                    ...
                    case 0:
                        {
                            ...
                            {
                                SingleTestResult.Text ="Wynik: "+ result.SingleBitTestResult.TestPassed.ToString();
                            ...
                            {
                                SeriesResultText.Text ="Wynik: "+ result.SeriesTestResult.TestPassed.ToString();
                            ...
                            {
                                LongSeriesResultText.Text ="Wynik: "+ result.LongSeriesTestResult.TestPassed.ToString();
                            ...
                            {
                                PokerTestResultText.Text ="Wynik: "+ result.PokerTestResult.TestPassed.ToString();
                    ...
                    case 1:
                        {
                            ...
                            SingletestInfo.Text += result.SingleBitTestResult.NumberOfOneBits.ToString();

                            if (result.SingleBitTestResult.TestPassed)
                            {
                                SingleTestResult.Text += result.SingleBitTestResult.TestPassed.ToString();
                                SingleTestResult.Foreground = Brushes.Green;
                            }
                            else
                            {
                            ...
                            SeriesOnesText.Text += seriesOne;
                            SeriesZerosText.Text += seriesZero;
                            if (result.SeriesTestResult.TestPassed)
                            {
                                SeriesResultText.Text += result.SeriesTestResult.TestPassed.ToString();
                                SeriesResultText.Foreground = Brushes.Green;
                            }
                            else
                            {
                            ...
                            LongSeriesInfoText.Text += result.LongSeriesTestResult.LongestSeries.ToString();

                            if (result.LongSeriesTestResult.TestPassed)
                            {
                                LongSeriesResultText.Text += result.LongSeriesTestResult.TestPassed.ToString();
                                LongSeriesResultText.Foreground = Brushes.Green;
                            }
                            else
                            {
                            ...
                            PokerTestXText.Text += result.PokerTestResult.Result.ToString();

                            if (result.PokerTestResult.TestPassed)
                            {
                                PokerTestResultText.Text += result.PokerTestResult.TestPassed.ToString();
                                PokerTestResultText.Foreground = Brushes.Green;
                            }
                            else
                            {
